...
### func \(\*NFTDropClaimConditions\) [Get](<https://github.com/mry-am/thirdweb-go-sdk/blob/main/thirdweb/nft_drop_claim_conditions.go#L77>)

```go
func (claim *NFTDropClaimConditions) Get(ctx context.Context, claimConditionId int) (*ClaimConditionOutput, error)
```

### func \(\*NFTDropClaimConditions\) [GetActive](<https://github.com/mry-am/thirdweb-go-sdk/blob/main/thirdweb/nft_drop_claim_conditions.go#L53>)
...
### func \(\*NFTDropClaimConditions\) [GetAll](<https://github.com/mry-am/thirdweb-go-sdk/blob/main/thirdweb/nft_drop_claim_conditions.go#L113>)
...
### func \(\*NFTDropClaimConditions\) [GetClaimerProofs](<https://github.com/mry-am/thirdweb-go-sdk/blob/main/thirdweb/nft_drop_claim_conditions.go#L166-L169>)
